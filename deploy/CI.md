...
| 公网入口 | **只有两个域名(2026-09-21 上线)**:宿主 Nginx 终结公信证书,`gateway.5home.online`(管理台)/ `gatewayapi.5home.online`(数据面),均 443,回源网关 127.0.0.1 | 见 `deploy/README.md`「域名边缘」;裸 IP / 非标端口入口(`:17080`、`:17090`)已下线,公网不可达 |
